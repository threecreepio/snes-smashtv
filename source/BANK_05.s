...
B_5835D:
  ...
  STA.W $0C9C,X                                   ; 058386 9D 9C 0C 
  LDA.W $197B,Y                                   ; 058389 B9 7B 19 
  STA.W $14A0,X                                   ; 05838C 9D A0 14 
...
B_583CC:
  LDA.W XexzyFlyingDrop,X                         ; 0583CC BD D4 06 
...
B_583E5:
  ...
  LDA.W XexzyFlyingDrop,X                         ; 0583E7 BD D4 06 
...
B_58409:
  LDA.W XexzyFlyingDrop,X                         ; 058409 BD D4 06 
  BEQ.B B_58415                                   ; 05840C F0 07 
  STX.B $1F                                       ; 05840E 86 1F 
  JSR.W L_58E29                                   ; 058410 20 29 8E 
...
B_58462:
  ...
  JSR.W L_58E29                                   ; 05848B 20 29 8E 
  JMP.W D_58494                                   ; 05848E 4C 94 84 
B_58491:
  JSR.W L_58E3E                                   ; 058491 20 3E 8E 
D_58494:
...
B_584AC:
  ...
  LDA.W XexzyFlyingDrop,X                         ; 0584AE BD D4 06 
...
B_585E9:
  ...
  PHY                                             ; 0585F2 5A 
  LDA.W XexzyFlyingDrop,X                         ; 0585F3 BD D4 06 
...
L_5860C:
  CLC                                             ; 05860C 18 
  LDA.W $11F6,X                                   ; 05860D BD F6 11 
  ADC.W $089C,X                                   ; 058610 7D 9C 08 
  ASL                                             ; 058613 0A 
  TAY                                             ; 058614 A8 
  ...
  LDA.W $0B48,X                                   ; 058629 BD 48 0B 
  STA.B $20                                       ; 05862C 85 20 
  LDA.W $0C9E,X                                   ; 05862E BD 9E 0C 
...
B_58685:
  ...
  LDA.W $1516,X                                   ; 05869D BD 16 15 
  STA.B XexzyItemLocationMaybe                    ; 0586A0 85 27 
  LDA.W $1588,X                                   ; 0586A2 BD 88 15 
  STA.B XexzyItemXPickupMaybe                     ; 0586A5 85 28 
  LDA.W $15FA,X                                   ; 0586A7 BD FA 15 
  STA.B $29                                       ; 0586AA 85 29 
  LDA.W $166C,X                                   ; 0586AC BD 6C 16 
...
B_586B6:
  ...
  PHY                                             ; 0586BF 5A 
  LDA.W XexzyFlyingDrop,X                         ; 0586C0 BD D4 06 
...
L_586D9:
  CLC                                             ; 0586D9 18 
  LDA.W $11F6,X                                   ; 0586DA BD F6 11 
  ADC.W $089C,X                                   ; 0586DD 7D 9C 08 
  ASL                                             ; 0586E0 0A 
  TAY                                             ; 0586E1 A8 
  ...
  LDA.W $0B48,X                                   ; 0586F6 BD 48 0B 
  STA.B $20                                       ; 0586F9 85 20 
  LDA.W $0C9E,X                                   ; 0586FB BD 9E 0C 
...
B_58700:
  ...
  JSR.W L_58E29                                   ; 058732 20 29 8E 
  RTS                                             ; 058735 60 

B_58736:
  JSR.W L_58E3E                                   ; 058736 20 3E 8E 
  RTS                                             ; 058739 60 
...
B_58886:
  ...
  JSL L_F830F                                     ; 058898 22 0F 83 0F 
  SEP.B #$30                                      ; 05889C E2 30 
  PLX                                             ; 05889E FA 
...
B_58A7D:
  ...
  STA.W $0D80,X                                   ; 058A83 9D 80 0D 
  LDA.B #$00                                      ; 058A86 A9 00 
  STA.W $0828,X                                   ; 058A88 9D 28 08 
  STZ.W $090C,X                                   ; 058A8B 9E 0C 09 
  STZ.W $097E,X                                   ; 058A8E 9E 7E 09 
  STZ.W $09F0,X                                   ; 058A91 9E F0 09 
  STZ.W $0A62,X                                   ; 058A94 9E 62 0A 
  RTS                                             ; 058A97 60 
...
B_58AA2:
  ...
  STA.W $0744,X                                   ; 058AA8 9D 44 07 
  LDA.B #$01                                      ; 058AAB A9 01 
  STA.W $0D80,X                                   ; 058AAD 9D 80 0D 
  LDA.B #$00                                      ; 058AB0 A9 00 
  STA.W $0828,X                                   ; 058AB2 9D 28 08 
  STZ.W $090C,X                                   ; 058AB5 9E 0C 09 
  STZ.W $097E,X                                   ; 058AB8 9E 7E 09 
  STZ.W $09F0,X                                   ; 058ABB 9E F0 09 
  STZ.W $0A62,X                                   ; 058ABE 9E 62 0A 
  RTS                                             ; 058AC1 60 
...
L_58CD0:
  ...
  STA.W $0744,X                                   ; 058CD2 9D 44 07 
  LDA.B #$00                                      ; 058CD5 A9 00 
  STA.W $0828,X                                   ; 058CD7 9D 28 08 
  LDA.B #$20                                      ; 058CDA A9 20 
  STA.W $13BC,X                                   ; 058CDC 9D BC 13 
  LDA.B #$32                                      ; 058CDF A9 32 
  STA.W $142E,X                                   ; 058CE1 9D 2E 14 
  LDA.B #$04                                      ; 058CE4 A9 04 
  STA.W $134A,X                                   ; 058CE6 9D 4A 13 
  STZ.W $12D8,X                                   ; 058CE9 9E D8 12 
  RTS                                             ; 058CEC 60 


L_58CED:
  LDA.B #$09                                      ; 058CED A9 09 
  STA.W $0744,X                                   ; 058CEF 9D 44 07 
  LDA.B #$00                                      ; 058CF2 A9 00 
  STA.W $0828,X                                   ; 058CF4 9D 28 08 
  LDA.B #$20                                      ; 058CF7 A9 20 
  STA.W $13BC,X                                   ; 058CF9 9D BC 13 
  LDA.B #$32                                      ; 058CFC A9 32 
  STA.W $142E,X                                   ; 058CFE 9D 2E 14 
  STZ.W $090C,X                                   ; 058D01 9E 0C 09 
  STZ.W $097E,X                                   ; 058D04 9E 7E 09 
  STZ.W $09F0,X                                   ; 058D07 9E F0 09 
  STZ.W $0A62,X                                   ; 058D0A 9E 62 0A 
  LDA.B #$04                                      ; 058D0D A9 04 
  STA.W $134A,X                                   ; 058D0F 9D 4A 13 
  STZ.W $12D8,X                                   ; 058D12 9E D8 12 
  PHX                                             ; 058D15 DA 
  REP.B #$10                                      ; 058D16 C2 10 
  LDA.B #$07                                      ; 058D18 A9 07 
  LDX.W #$FF06                                    ; 058D1A A2 06 FF 
  JSL L_F830F                                     ; 058D1D 22 0F 83 0F 
  SEP.B #$30                                      ; 058D21 E2 30 
  PLX                                             ; 058D23 FA 
  RTS                                             ; 058D24 60 
...
L_58D25:
  ...
  STA.W $0744,X                                   ; 058D27 9D 44 07 
  LDA.B #$00                                      ; 058D2A A9 00 
  STA.W $0828,X                                   ; 058D2C 9D 28 08 
  LDA.B #$20                                      ; 058D2F A9 20 
  STA.W $13BC,X                                   ; 058D31 9D BC 13 
  LDA.B #$32                                      ; 058D34 A9 32 
  STA.W $142E,X                                   ; 058D36 9D 2E 14 
  STZ.W $090C,X                                   ; 058D39 9E 0C 09 
  STZ.W $097E,X                                   ; 058D3C 9E 7E 09 
  STZ.W $09F0,X                                   ; 058D3F 9E F0 09 
  STZ.W $0A62,X                                   ; 058D42 9E 62 0A 
  LDA.B #$04                                      ; 058D45 A9 04 
  STA.W $134A,X                                   ; 058D47 9D 4A 13 
  STZ.W $12D8,X                                   ; 058D4A 9E D8 12 
  PHX                                             ; 058D4D DA 
  REP.B #$10                                      ; 058D4E C2 10 
  LDA.B #$07                                      ; 058D50 A9 07 
  LDX.W #$FF06                                    ; 058D52 A2 06 FF 
  JSL L_F830F                                     ; 058D55 22 0F 83 0F 
  SEP.B #$30                                      ; 058D59 E2 30 
  PLX                                             ; 058D5B FA 
  RTS                                             ; 058D5C 60 
...
L_58D5D:
  ...
  STA.W $0744,X                                   ; 058D5F 9D 44 07 
  LDA.B #$00                                      ; 058D62 A9 00 
  STA.W $0828,X                                   ; 058D64 9D 28 08 
  LDA.B #$40                                      ; 058D67 A9 40 
  STA.W $13BC,X                                   ; 058D69 9D BC 13 
  LDA.B #$32                                      ; 058D6C A9 32 
  STA.W $142E,X                                   ; 058D6E 9D 2E 14 
  STZ.W $090C,X                                   ; 058D71 9E 0C 09 
  STZ.W $097E,X                                   ; 058D74 9E 7E 09 
  STZ.W $09F0,X                                   ; 058D77 9E F0 09 
  STZ.W $0A62,X                                   ; 058D7A 9E 62 0A 
  LDA.B #$04                                      ; 058D7D A9 04 
  STA.W $134A,X                                   ; 058D7F 9D 4A 13 
  STZ.W $12D8,X                                   ; 058D82 9E D8 12 
  PHX                                             ; 058D85 DA 
  REP.B #$10                                      ; 058D86 C2 10 
  LDA.B #$07                                      ; 058D88 A9 07 
  LDX.W #$FF06                                    ; 058D8A A2 06 FF 
  JSL L_F830F                                     ; 058D8D 22 0F 83 0F 
  SEP.B #$30                                      ; 058D91 E2 30 
  PLX                                             ; 058D93 FA 
  RTS                                             ; 058D94 60 
...
L_58DBE:
  ...
  STA.W $0744,X                                   ; 058DC0 9D 44 07 
  LDA.B #$00                                      ; 058DC3 A9 00 
  STA.W $0828,X                                   ; 058DC5 9D 28 08 
  LDA.B #$60                                      ; 058DC8 A9 60 
  STA.W $13BC,X                                   ; 058DCA 9D BC 13 
  LDA.B #$32                                      ; 058DCD A9 32 
  STA.W $142E,X                                   ; 058DCF 9D 2E 14 
  LDY.B $1E                                       ; 058DD2 A4 1E 
  LDA.W $106E,Y                                   ; 058DD4 B9 6E 10 
  ASL                                             ; 058DD7 0A 
  TAY                                             ; 058DD8 A8 
  LDA.W D_58E09,Y                                 ; 058DD9 B9 09 8E 
  STA.W $090C,X                                   ; 058DDC 9D 0C 09 
  LDA.W D_58E0A,Y                                 ; 058DDF B9 0A 8E 
  STA.W $097E,X                                   ; 058DE2 9D 7E 09 
  LDA.W D_58E19,Y                                 ; 058DE5 B9 19 8E 
  STA.W $09F0,X                                   ; 058DE8 9D F0 09 
  LDA.W D_58E1A,Y                                 ; 058DEB B9 1A 8E 
  STA.W $0A62,X                                   ; 058DEE 9D 62 0A 
  LDA.B #$04                                      ; 058DF1 A9 04 
  STA.W $134A,X                                   ; 058DF3 9D 4A 13 
  STZ.W $12D8,X                                   ; 058DF6 9E D8 12 
  PHX                                             ; 058DF9 DA 
  REP.B #$10                                      ; 058DFA C2 10 
  LDA.B #$07                                      ; 058DFC A9 07 
  LDX.W #$FF06                                    ; 058DFE A2 06 FF 
  JSL L_F830F                                     ; 058E01 22 0F 83 0F 
  SEP.B #$30                                      ; 058E05 E2 30 
  PLX                                             ; 058E07 FA 
  RTS                                             ; 058E08 60 
...
L_58E29:
  TXA                                             ; 058E29 8A 
  CLC                                             ; 058E2A 18 
  ADC.B #$02                                      ; 058E2B 69 02 
  TAX                                             ; 058E2D AA 
  LDY.W $0744,X                                   ; 058E2E BC 44 07 
  LDA.W D_58E53,Y                                 ; 058E31 B9 53 8E 
  STA.B $04                                       ; 058E34 85 04 
  LDA.W D_58EFD,Y                                 ; 058E36 B9 FD 8E 
  STA.B $05                                       ; 058E39 85 05 
  JMP.W ($0004)                                   ; 058E3B 6C 04 00 

L_58E3E:
  TXA                                             ; 058E3E 8A 
  CLC                                             ; 058E3F 18 
  ADC.B #$02                                      ; 058E40 69 02 
  TAX                                             ; 058E42 AA 
  LDY.W $0744,X                                   ; 058E43 BC 44 07 
  LDA.W D_58FA7,Y                                 ; 058E46 B9 A7 8F 
  STA.B $04                                       ; 058E49 85 04 
  LDA.W D_59051,Y                                 ; 058E4B B9 51 90 
  STA.B $05                                       ; 058E4E 85 05 
  JMP.W ($0004)                                   ; 058E50 6C 04 00 

D_58E53:
.byte $FB,$FD,$FF,$01,$03,$05,$07,$09             ; 058E53 ..D.D... ????????
.byte $0B,$0D,$0F,$11,$13,$15,$17,$19             ; 058E5B ........ ????????
.byte $1B,$1D,$1F,$21,$23,$25,$25,$25             ; 058E63 .....DDD ???!#%%%
.byte $D7,$D9,$3D,$3F,$B0,$B2,$B4,$9B             ; 058E6B ........ ??=?????
.byte $28,$D6,$D8,$D8,$D8,$D8,$D8,$A1             ; 058E73 ........ (???????
.byte $AE,$41,$05,$25,$AF,$AF,$AF,$AF             ; 058E7B ...DDDDD ?A?%????
.byte $AF,$61,$8A,$8C,$8E,$90,$92,$94             ; 058E83 DD...... ?a??????
.byte $96,$98,$9A,$9C,$9E,$09,$74,$1B             ; 058E8B ....DDD. ??????t?
.byte $D4,$24,$28,$BD,$23,$7E,$F3,$78             ; 058E93 DDDDDDDD ?$(?#~?x
.byte $2F,$31,$33,$3F,$35,$AE,$B0,$D8             ; 058E9B ........ /13?5???
.byte $04,$06,$06,$68,$6A,$F5,$58,$8C             ; 058EA3 ....DDD. ???hj?X?
.byte $8E,$05,$07,$09,$09,$09,$09,$09             ; 058EAB ........ ????????
.byte $C7,$C9,$CB,$CD,$02,$85,$CE,$1C             ; 058EB3 ........ ????????
.byte $1E,$20,$2E,$35,$37,$39,$BB,$BD             ; 058EBB ........ ? .579??
.byte $BF,$C1,$C3,$C5,$F5,$C5,$25,$27             ; 058EC3 ...DDD.D ??????%'
.byte $2E,$2E,$2E,$2E,$2E,$2E,$BE,$BF             ; 058ECB DDDDD... ......??
.byte $C0,$C2,$C5,$F5,$F5,$C5,$F5,$C4             ; 058ED3 ..DDDDD. ????????
.byte $C6,$C8,$CA,$CC,$CE,$CE,$75,$82             ; 058EDB ....DDD. ??????u?
.byte $84,$84,$84,$13,$15,$17,$19,$D7             ; 058EE3 DDD..... ????????
.byte $D9,$DB,$19,$DD,$DF,$E1,$1B,$1D             ; 058EEB ........ ????????
.byte $5E,$60,$62,$64,$66,$68,$6A,$99             ; 058EF3 ........ ^`bdfhj?
.byte $C2,$C4                                     ; 058EFC ..       ??
D_58EFD:
.byte $90,$90,$90,$91,$91,$91,$91,$91             ; 058EFD ..D.D... ????????
.byte $91,$91,$91,$91,$91,$91,$91,$91             ; 058F05 ........ ????????
.byte $91,$91,$91,$91,$91,$91,$91,$91             ; 058F0D .....DDD ????????
.byte $91,$91,$92,$92,$92,$92,$92,$93             ; 058F15 ........ ????????
.byte $94,$94,$94,$94,$94,$94,$94,$95             ; 058F1D ........ ????????
.byte $95,$96,$97,$91,$97,$97,$97,$97             ; 058F25 ...DDDDD ????????
.byte $97,$98,$98,$98,$98,$98,$98,$98             ; 058F2D DD...... ????????
.byte $98,$98,$98,$98,$98,$99,$99,$9A             ; 058F35 ....DDD. ????????
.byte $9A,$9B,$9C,$9C,$9D,$9D,$9D,$9E             ; 058F3D DDDDDDDD ????????
.byte $9F,$9F,$9F,$92,$9F,$9F,$9F,$94             ; 058F45 ........ ????????
.byte $A0,$A0,$A0,$A0,$A0,$A0,$A1,$A1             ; 058F4D ....DDD. ????????
.byte $A1,$A2,$A2,$A2,$A2,$A2,$A2,$A2             ; 058F55 ........ ????????
.byte $A2,$A2,$A2,$A2,$A3,$A3,$A3,$A4             ; 058F5D ........ ????????
.byte $A4,$A4,$A4,$A4,$A4,$A4,$A4,$A4             ; 058F65 ........ ????????
.byte $A4,$A4,$A4,$A4,$A4,$A4,$A5,$A5             ; 058F6D ...DDD.D ????????
.byte $A5,$A5,$A5,$A5,$A5,$A5,$A5,$A5             ; 058F75 DDDDD... ????????
.byte $A5,$A5,$A4,$A4,$A4,$A4,$A4,$A5             ; 058F7D ..DDDDD. ????????
.byte $A5,$A5,$A5,$A5,$A5,$A5,$A6,$A6             ; 058F85 ....DDD. ????????
.byte $A6,$A6,$A6,$A7,$A7,$A7,$A7,$A7             ; 058F8D DDD..... ????????
...
.byte $1C,$1E,$20,$22,$24,$90,$90,$AC             ; 058FB7 ......DD ?? "$???
.byte $D8,$31,$3E,$A4,$B1,$B3,$8F,$1C             ; 058FBF ........ ?1>?????
.byte $CA,$D7,$95,$95,$95,$95,$95,$A2             ; 058FC7 ........ ????????
.byte $35,$F9,$A3,$90,$55,$55,$55,$55             ; 058FCF .....D.. 5???UUUU
.byte $55,$7E,$8B,$8D,$8F,$91,$93,$95             ; 058FD7 .D...... U~??????
.byte $97,$99,$9B,$9D,$A4,$0F,$7A,$21             ; 058FDF ....DDDD ??????z!
.byte $DA,$2A,$2E,$C3,$29,$84,$F9,$7E             ; 058FE7 DDDDDDDD ?*.?)??~
.byte $30,$32,$34,$A4,$3B,$AF,$F1,$95             ; 058FEF ....D... 024?;???
...
.byte $C0,$C2,$C4,$F4,$24,$F4,$26,$28             ; 059017 ....D..D ????$?&(
.byte $B8,$B8,$B8,$B8,$B8,$B8,$B8,$B8             ; 05901F .DDD.... ????????
.byte $C1,$C3,$F4,$24,$24,$F4,$24,$C5             ; 059027 ...D.DD. ???$$?$?
.byte $C7,$C9,$CB,$CD,$6F,$6F,$79,$83             ; 05902F ......D. ????ooy?
...
.byte $91,$91,$91,$91,$91,$91,$91,$91             ; 059061 ......DD ????????
.byte $91,$92,$92,$92,$92,$92,$93,$94             ; 059069 ........ ????????
.byte $94,$94,$95,$95,$95,$95,$95,$95             ; 059071 ........ ????????
.byte $96,$96,$97,$91,$98,$98,$98,$98             ; 059079 .....D.. ????????
.byte $98,$98,$98,$98,$98,$98,$98,$98             ; 059081 .D...... ????????
.byte $98,$98,$98,$98,$98,$99,$99,$9A             ; 059089 ....DDDD ????????
.byte $9A,$9B,$9C,$9C,$9D,$9D,$9D,$9E             ; 059091 DDDDDDDD ????????
.byte $9F,$9F,$9F,$92,$9F,$9F,$9F,$95             ; 059099 ....D... ????????
...
.byte $A4,$A4,$A4,$A4,$A5,$A4,$A5,$A5             ; 0590C1 ....D..D ????????
.byte $A5,$A5,$A5,$A5,$A5,$A5,$A5,$A5             ; 0590C9 .DDD.... ????????
.byte $A5,$A5,$A4,$A5,$A5,$A4,$A5,$A5             ; 0590D1 ...D.DD. ????????
.byte $A5,$A5,$A5,$A5,$A6,$A6,$A6,$A6             ; 0590D9 ......D. ????????
...
B_59156:
  ...
  LDA.W $0FFC,Y                                   ; 059166 B9 FC 0F 
  JSL L_E46D                                      ; 059169 22 6D E4 00 
  LDA.W $0786,Y                                   ; 05916D B9 86 07 
  TAY                                             ; 059170 A8 
...
.byte $00,$00,$01,$01,$00,$00                     ; 05918B DDDDD.   ??????
  ...
  STZ.W $090C,X                                   ; 059190 9E 0C 09 
  STZ.W $097E,X                                   ; 059193 9E 7E 09 
  STZ.W $09F0,X                                   ; 059196 9E F0 09 
  STZ.W $0A62,X                                   ; 059199 9E 62 0A 
  LDA.B #$01                                      ; 05919C A9 01 
  STA.W $134A,X                                   ; 05919E 9D 4A 13 
  LDA.B #$FF                                      ; 0591A1 A9 FF 
  STA.W $12D8,X                                   ; 0591A3 9D D8 12 
  LDA.B #$17                                      ; 0591A6 A9 17 
  STA.W $0744,X                                   ; 0591A8 9D 44 07 
  RTS                                             ; 0591AB 60 
...
.byte $D0,$05,$A9,$2A,$20,$44,$88,$60             ; 0597A7 ........ ???* D?`
  ...
  CLC                                             ; 0597B4 18 
  ADC.W $0F48,X                                   ; 0597B5 7D 48 0F 
  STA.W $0F48,X                                   ; 0597B8 9D 48 0F 
...
B_597EF:
  ...
  LDA.W $106E,Y                                   ; 0597F1 B9 6E 10 
  TAY                                             ; 0597F4 A8 
  CLC                                             ; 0597F5 18 
  LDA.W XexzyCharX,X                              ; 0597F6 BD 46 0B 
  ...
  STA.W XexzyCharX,X                              ; 059804 9D 46 0B 
B_59807:
  CLC                                             ; 059807 18 
  LDA.W $0C9C,X                                   ; 059808 BD 9C 0C 
  ...
  STA.W $0C9C,X                                   ; 059816 9D 9C 0C 
B_59819:
  LDA.W $142E,X                                   ; 059819 BD 2E 14 
  AND.B #$F1                                      ; 05981C 29 F1 
  STA.W $142E,X                                   ; 05981E 9D 2E 14 
  JSR.W L_58926                                   ; 059821 20 26 89 
  LDA.B #$FF                                      ; 059824 A9 FF 
  XBA                                             ; 059826 EB 
  JSL L_ECA95                                     ; 059827 22 95 CA 0E 
  AND.B #$03                                      ; 05982B 29 03 
  TAY                                             ; 05982D A8 
  LDA.W D_59841,Y                                 ; 05982E B9 41 98 
  BEQ.B B_59840                                   ; 059831 F0 0D 
  PHX                                             ; 059833 DA 
  REP.B #$10                                      ; 059834 C2 10 
  TAX                                             ; 059836 AA 
  LDA.B #$07                                      ; 059837 A9 07 
  JSL L_F830F                                     ; 059839 22 0F 83 0F 
  SEP.B #$30                                      ; 05983D E2 30 
  PLX                                             ; 05983F FA 
B_59840:
  RTS                                             ; 059840 60 
...
B_598E1:
  ...
  STA.W $1897,X                                   ; 0598E3 9D 97 18 
  LDA.B #$06                                      ; 0598E6 A9 06 
  STA.W $1899,X                                   ; 0598E8 9D 99 18 
  STZ.W $189B,X                                   ; 0598EB 9E 9B 18 
  LDA.W $189F                                     ; 0598EE AD 9F 18 
  STA.W XexzyAmmoCounter,X                        ; 0598F1 9D 9D 18 
  LDA.B #$0A                                      ; 0598F4 A9 0A 
  STA.W $18B0,X                                   ; 0598F6 9D B0 18 
  JSL L_ECA95                                     ; 0598F9 22 95 CA 0E 
  AND.B #$3F                                      ; 0598FD 29 3F 
  CLC                                             ; 0598FF 18 
  ADC.B #$40                                      ; 059900 69 40 
  STA.W XexzyDropCountDownTimer                   ; 059902 8D AE 05 
...
B_5994C:
  ...
  STA.W $1897,X                                   ; 05994E 9D 97 18 
  LDA.B #$06                                      ; 059951 A9 06 
  STA.W $1899,X                                   ; 059953 9D 99 18 
  STZ.W $189B,X                                   ; 059956 9E 9B 18 
  LDA.W $18A0                                     ; 059959 AD A0 18 
  STA.W XexzyAmmoCounter,X                        ; 05995C 9D 9D 18 
  LDA.B #$09                                      ; 05995F A9 09 
  STA.W $18B0,X                                   ; 059961 9D B0 18 
  JSL L_ECA95                                     ; 059964 22 95 CA 0E 
  AND.B #$3F                                      ; 059968 29 3F 
  CLC                                             ; 05996A 18 
  ADC.B #$40                                      ; 05996B 69 40 
  STA.W XexzyDropCountDownTimer                   ; 05996D 8D AE 05 
...
B_599D1:
  ...
  STA.W $1897,X                                   ; 0599D3 9D 97 18 
  LDA.B #$06                                      ; 0599D6 A9 06 
  STA.W $1899,X                                   ; 0599D8 9D 99 18 
  STZ.W $189B,X                                   ; 0599DB 9E 9B 18 
  LDA.W $18A1                                     ; 0599DE AD A1 18 
  STA.W XexzyAmmoCounter,X                        ; 0599E1 9D 9D 18 
  LDA.B #$04                                      ; 0599E4 A9 04 
  STA.W $18B0,X                                   ; 0599E6 9D B0 18 
  JSL L_ECA95                                     ; 0599E9 22 95 CA 0E 
  AND.B #$3F                                      ; 0599ED 29 3F 
  CLC                                             ; 0599EF 18 
  ADC.B #$40                                      ; 0599F0 69 40 
  STA.W XexzyDropCountDownTimer                   ; 0599F2 8D AE 05 
...
B_59AAC:
  ...
  STA.W $1897,X                                   ; 059AAE 9D 97 18 
  LDA.B #$06                                      ; 059AB1 A9 06 
  STA.W $1899,X                                   ; 059AB3 9D 99 18 
  STZ.W $189B,X                                   ; 059AB6 9E 9B 18 
  LDA.W $18A2                                     ; 059AB9 AD A2 18 
  STA.W XexzyAmmoCounter,X                        ; 059ABC 9D 9D 18 
  LDA.B #$09                                      ; 059ABF A9 09 
  STA.W $18B0,X                                   ; 059AC1 9D B0 18 
  JSL L_ECA95                                     ; 059AC4 22 95 CA 0E 
  AND.B #$3F                                      ; 059AC8 29 3F 
  CLC                                             ; 059ACA 18 
  ADC.B #$40                                      ; 059ACB 69 40 
  STA.W XexzyDropCountDownTimer                   ; 059ACD 8D AE 05 
...
B_59ADA:
  ...
  STA.W $0744,X                                   ; 059ADE 9D 44 07 
  LDA.B #$00                                      ; 059AE1 A9 00 
  STA.W $0828,X                                   ; 059AE3 9D 28 08 
  LDA.B $1E                                       ; 059AE6 A5 1E 
  STA.W $05D0                                     ; 059AE8 8D D0 05 
  LDA.B #$05                                      ; 059AEB A9 05 
  STA.W $0FBA,X                                   ; 059AED 9D BA 0F 
  STZ.W $0D80,X                                   ; 059AF0 9E 80 0D 
  LDA.B #$E6                                      ; 059AF3 A9 E6 
  STA.W $13BC,X                                   ; 059AF5 9D BC 13 
  PHX                                             ; 059AF8 DA 
  LDY.W $14A0,X                                   ; 059AF9 BC A0 14 
  JSL L_AEF1                                      ; 059AFC 22 F1 AE 00 
  LDA.W $14A0,X                                   ; 059B00 BD A0 14 
  TAX                                             ; 059B03 AA 
...
B_59B16:
  PLX                                             ; 059B16 FA 
  JSL L_ECA95                                     ; 059B17 22 95 CA 0E 
  AND.B #$3F                                      ; 059B1B 29 3F 
  CLC                                             ; 059B1D 18 
  ADC.B #$40                                      ; 059B1E 69 40 
  STA.W XexzyDropCountDownTimer                   ; 059B20 8D AE 05 
  RTS                                             ; 059B23 60 
...
B_59B5C:
  JSL L_ECA95                                     ; 059B5C 22 95 CA 0E 
  AND.B #$3F                                      ; 059B60 29 3F 
  CLC                                             ; 059B62 18 
  ADC.B #$40                                      ; 059B63 69 40 
  STA.W XexzyDropCountDownTimer                   ; 059B65 8D AE 05 
...
B_59B74:
  ...
  STA.W $0744,X                                   ; 059B88 9D 44 07 
  LDA.B #$02                                      ; 059B8B A9 02 
  STA.W $0828,X                                   ; 059B8D 9D 28 08 
  LDY.W $05CE                                     ; 059B90 AC CE 05 
  LDA.W XexzyCharX,Y                              ; 059B93 B9 46 0B 
  STA.W XexzyCharX,X                              ; 059B96 9D 46 0B 
  SEC                                             ; 059B99 38 
  LDA.W $0C9C,Y                                   ; 059B9A B9 9C 0C 
  SBC.B #$16                                      ; 059B9D E9 16 
  STA.W $0C9C,X                                   ; 059B9F 9D 9C 0C 
  SEC                                             ; 059BA2 38 
  LDA.W XexzyCharX,X                              ; 059BA3 BD 46 0B 
...
B_59BAC:
  STA.W $1516,X                                   ; 059BAC 9D 16 15 
  CLC                                             ; 059BAF 18 
  LDA.W XexzyCharX,X                              ; 059BB0 BD 46 0B 
...
B_59BB9:
  STA.W $1588,X                                   ; 059BB9 9D 88 15 
  SEC                                             ; 059BBC 38 
  LDA.W $0C9C,X                                   ; 059BBD BD 9C 0C 
...
B_59BC6:
  STA.W $15FA,X                                   ; 059BC6 9D FA 15 
  CLC                                             ; 059BC9 18 
  LDA.W $0C9C,X                                   ; 059BCA BD 9C 0C 
...
B_59BD3:
  STA.W $166C,X                                   ; 059BD3 9D 6C 16 
  LDA.B #$00                                      ; 059BD6 A9 00 
  STA.W $0D80,X                                   ; 059BD8 9D 80 0D 
  ASL                                             ; 059BDB 0A 
  TAY                                             ; 059BDC A8 
  PHB                                             ; 059BDD 8B 
  ...
  STA.W $090C,X                                   ; 059BE5 9D 0C 09 
  LDA.W D_384EF,Y                                 ; 059BE8 B9 EF 84 
  STA.W $097E,X                                   ; 059BEB 9D 7E 09 
  LDA.W D_3856E,Y                                 ; 059BEE B9 6E 85 
  STA.W $09F0,X                                   ; 059BF1 9D F0 09 
  LDA.W D_3856F,Y                                 ; 059BF4 B9 6F 85 
  STA.W $0A62,X                                   ; 059BF7 9D 62 0A 
  PLB                                             ; 059BFA AB 
  LDA.B #$42                                      ; 059BFB A9 42 
  STA.W $13BC,X                                   ; 059BFD 9D BC 13 
  LDA.B #$23                                      ; 059C00 A9 23 
  STA.W $142E,X                                   ; 059C02 9D 2E 14 
  JSL L_AECB                                      ; 059C05 22 CB AE 00 
  TYA                                             ; 059C09 98 
  STA.W $14A0,X                                   ; 059C0A 9D A0 14 
  LDA.B #$01                                      ; 059C0D A9 01 
  STA.W $175E,Y                                   ; 059C0F 99 5E 17 
  JSL L_AEF1                                      ; 059C12 22 F1 AE 00 
  PHX                                             ; 059C16 DA 
  REP.B #$10                                      ; 059C17 C2 10 
  SEP.B #$20                                      ; 059C19 E2 20 
  LDA.B #$07                                      ; 059C1B A9 07 
  LDX.W #$FF10                                    ; 059C1D A2 10 FF 
  JSL L_F830F                                     ; 059C20 22 0F 83 0F 
  SEP.B #$30                                      ; 059C24 E2 30 
  PLX                                             ; 059C26 FA 
  RTS                                             ; 059C27 60 
...
B_59C2E:
  ...
  JSL L_ECA95                                     ; 059C33 22 95 CA 0E 
  AND.B #$3F                                      ; 059C37 29 3F 
  CLC                                             ; 059C39 18 
  ADC.B #$40                                      ; 059C3A 69 40 
  STA.W XexzyDropCountDownTimer                   ; 059C3C 8D AE 05 
...
B_59C54:
  ...
  STA.W $0744,X                                   ; 059C56 9D 44 07 
  LDA.B #$00                                      ; 059C59 A9 00 
  STA.W $0828,X                                   ; 059C5B 9D 28 08 
  JSR.W L_59C9D                                   ; 059C5E 20 9D 9C 
  LDA.B $1E                                       ; 059C61 A5 1E 
  STA.W $0FBA,X                                   ; 059C63 9D BA 0F 
  TAY                                             ; 059C66 A8 
  TXA                                             ; 059C67 8A 
...
B_59CE6:
  PLX                                             ; 059CE6 FA 
  JSL L_ECA95                                     ; 059CE7 22 95 CA 0E 
  AND.B #$3F                                      ; 059CEB 29 3F 
  CLC                                             ; 059CED 18 
  ADC.B #$40                                      ; 059CEE 69 40 
  STA.W XexzyDropCountDownTimer                   ; 059CF0 8D AE 05 
  ...
  JSL L_ECA95                                     ; 059D03 22 95 CA 0E 
  AND.B #$3F                                      ; 059D07 29 3F 
  CLC                                             ; 059D09 18 
  ADC.B #$40                                      ; 059D0A 69 40 
  STA.W XexzyDropCountDownTimer                   ; 059D0C 8D AE 05 
  PHX                                             ; 059D0F DA 
  REP.B #$10                                      ; 059D10 C2 10 
  LDA.B #$07                                      ; 059D12 A9 07 
  LDX.W #$FF0E                                    ; 059D14 A2 0E FF 
  JSL L_F830F                                     ; 059D17 22 0F 83 0F 
  SEP.B #$30                                      ; 059D1B E2 30 
...
B_59D5B:
  ...
  JSL L_ECA95                                     ; 059D62 22 95 CA 0E 
  AND.B #$3F                                      ; 059D66 29 3F 
  CLC                                             ; 059D68 18 
  ADC.B #$40                                      ; 059D69 69 40 
  STA.W XexzyDropCountDownTimer                   ; 059D6B 8D AE 05 
  PHX                                             ; 059D6E DA 
  REP.B #$10                                      ; 059D6F C2 10 
  LDA.B #$07                                      ; 059D71 A9 07 
  LDX.W #$FF10                                    ; 059D73 A2 10 FF 
  JSL L_F830F                                     ; 059D76 22 0F 83 0F 
  SEP.B #$30                                      ; 059D7A E2 30 
  PLX                                             ; 059D7C FA 
  RTS                                             ; 059D7D 60 
...
B_59D84:
  ...
  STA.W $0828,X                                   ; 059D86 9D 28 08 
  STZ.B $41,X                                     ; 059D89 74 41 
  LDA.B #$49                                      ; 059D8B A9 49 
  STA.W $0744,X                                   ; 059D8D 9D 44 07 
  LDA.W XexzyCharX,X                              ; 059D90 BD 46 0B 
  STA.W $1ADF                                     ; 059D93 8D DF 1A 
  LDA.W $0C9C,X                                   ; 059D96 BD 9C 0C 
  STA.W $1AE1                                     ; 059D99 8D E1 1A 
  LDA.B $1E                                       ; 059D9C A5 1E 
  STA.W $0FBA,X                                   ; 059D9E 9D BA 0F 
  TAY                                             ; 059DA1 A8 
  ...
  STA.W $090C,X                                   ; 059DC0 9D 0C 09 
  LDA.W $1AE6                                     ; 059DC3 AD E6 1A 
  STA.W $097E,X                                   ; 059DC6 9D 7E 09 
  LDA.W $1AE7                                     ; 059DC9 AD E7 1A 
  STA.W $09F0,X                                   ; 059DCC 9D F0 09 
  LDA.W $1AE8                                     ; 059DCF AD E8 1A 
  STA.W $0A62,X                                   ; 059DD2 9D 62 0A 
  JSL L_ECA95                                     ; 059DD5 22 95 CA 0E 
  AND.B #$3F                                      ; 059DD9 29 3F 
  CLC                                             ; 059DDB 18 
  ADC.B #$40                                      ; 059DDC 69 40 
  STA.W XexzyDropCountDownTimer                   ; 059DDE 8D AE 05 
  PHX                                             ; 059DE1 DA 
  REP.B #$10                                      ; 059DE2 C2 10 
  LDA.B #$07                                      ; 059DE4 A9 07 
  LDX.W #$FF12                                    ; 059DE6 A2 12 FF 
  JSL L_F830F                                     ; 059DE9 22 0F 83 0F 
  SEP.B #$30                                      ; 059DED E2 30 
  PLX                                             ; 059DEF FA 
  RTS                                             ; 059DF0 60 
...
B_59DF9:
  ...
  STA.W $0828,X                                   ; 059DFB 9D 28 08 
  STZ.B $41,X                                     ; 059DFE 74 41 
  LDA.B #$4A                                      ; 059E00 A9 4A 
  STA.W $0744,X                                   ; 059E02 9D 44 07 
  LDA.W XexzyCharX,X                              ; 059E05 BD 46 0B 
  STA.W $1ADF                                     ; 059E08 8D DF 1A 
  LDA.W $0C9C,X                                   ; 059E0B BD 9C 0C 
  ...
  STA.W $090C,X                                   ; 059E45 9D 0C 09 
  LDA.W $1AE6                                     ; 059E48 AD E6 1A 
  STA.W $097E,X                                   ; 059E4B 9D 7E 09 
  LDA.W $1AE7                                     ; 059E4E AD E7 1A 
  STA.W $09F0,X                                   ; 059E51 9D F0 09 
  LDA.W $1AE8                                     ; 059E54 AD E8 1A 
  STA.W $0A62,X                                   ; 059E57 9D 62 0A 
  JSL L_ECA95                                     ; 059E5A 22 95 CA 0E 
  AND.B #$3F                                      ; 059E5E 29 3F 
  CLC                                             ; 059E60 18 
  ADC.B #$40                                      ; 059E61 69 40 
  STA.W XexzyDropCountDownTimer                   ; 059E63 8D AE 05 
  PHX                                             ; 059E66 DA 
  REP.B #$10                                      ; 059E67 C2 10 
  LDA.B #$07                                      ; 059E69 A9 07 
  LDX.W #$FF16                                    ; 059E6B A2 16 FF 
  JSL L_F830F                                     ; 059E6E 22 0F 83 0F 
  SEP.B #$30                                      ; 059E72 E2 30 
  PLX                                             ; 059E74 FA 
  RTS                                             ; 059E75 60 
...
B_59E7E:
  ...
  STA.W $0828,X                                   ; 059E80 9D 28 08 
  STZ.B $41,X                                     ; 059E83 74 41 
  LDA.B #$48                                      ; 059E85 A9 48 
  STA.W $0744,X                                   ; 059E87 9D 44 07 
  LDA.W XexzyCharX,X                              ; 059E8A BD 46 0B 
  STA.W $1ADF                                     ; 059E8D 8D DF 1A 
  LDA.W $0C9C,X                                   ; 059E90 BD 9C 0C 
  STA.W $1AE1                                     ; 059E93 8D E1 1A 
  LDA.W $102C,X                                   ; 059E96 BD 2C 10 
...
B_59EAB:
  ...
  STA.W $090C,X                                   ; 059ECF 9D 0C 09 
  LDA.W $1AE6                                     ; 059ED2 AD E6 1A 
  STA.W $097E,X                                   ; 059ED5 9D 7E 09 
...
B_59EF2:
  JSL L_ECA95                                     ; 059EF2 22 95 CA 0E 
  ...
  XBA                                             ; 059F00 EB 
  LDA.W $1110,X                                   ; 059F01 BD 10 11 
  ASL                                             ; 059F04 0A 
  ASL                                             ; 059F05 0A 
  STA.B $04                                       ; 059F06 85 04 
  JSL L_ECA95                                     ; 059F08 22 95 CA 0E 
  ...
  PHX                                             ; 059F15 DA 
  REP.B #$10                                      ; 059F16 C2 10 
  SEP.B #$20                                      ; 059F18 E2 20 
  TAX                                             ; 059F1A AA 
  LDA.B #$07                                      ; 059F1B A9 07 
  JSL L_F830F                                     ; 059F1D 22 0F 83 0F 
  SEP.B #$30                                      ; 059F21 E2 30 
  PLX                                             ; 059F23 FA 
  RTS                                             ; 059F24 60 
...
.byte $AD,$D6,$05,$10,$01,$60                     ; 059F36 ......   ?????`
  ...
  STA.W $0828,X                                   ; 059F3D 9D 28 08 
  STZ.B $41,X                                     ; 059F40 74 41 
  LDA.B #$4D                                      ; 059F42 A9 4D 
  STA.W $0744,X                                   ; 059F44 9D 44 07 
  LDA.W XexzyCharX,X                              ; 059F47 BD 46 0B 
  STA.W $1ADF                                     ; 059F4A 8D DF 1A 
  LDA.W $0C9C,X                                   ; 059F4D BD 9C 0C 
  STA.W $1AE1                                     ; 059F50 8D E1 1A 
  LDA.B $1E                                       ; 059F53 A5 1E 
  STA.W $0FBA,X                                   ; 059F55 9D BA 0F 
  TAY                                             ; 059F58 A8 
  ...
  STA.W $090C,X                                   ; 059F77 9D 0C 09 
  LDA.W $1AE6                                     ; 059F7A AD E6 1A 
  STA.W $097E,X                                   ; 059F7D 9D 7E 09 
  LDA.W $1AE7                                     ; 059F80 AD E7 1A 
  STA.W $09F0,X                                   ; 059F83 9D F0 09 
  LDA.W $1AE8                                     ; 059F86 AD E8 1A 
  STA.W $0A62,X                                   ; 059F89 9D 62 0A 
  ...
  REP.B #$10                                      ; 059F9E C2 10 
  LDA.B #$07                                      ; 059FA0 A9 07 
  LDX.W #$FF0F                                    ; 059FA2 A2 0F FF 
  JSL L_F830F                                     ; 059FA5 22 0F 83 0F 
  SEP.B #$10                                      ; 059FA9 E2 10 
  RTS                                             ; 059FAB 60 
...
B_5A086:
  ...
  LDA.W $0FFC,Y                                   ; 05A098 B9 FC 0F 
  JSL L_E46D                                      ; 05A09B 22 6D E4 00 
  LDA.W $0786,Y                                   ; 05A09F B9 86 07 
  TAY                                             ; 05A0A2 A8 
...
B_5A111:
  ...
  LDA.W $0FFC,Y                                   ; 05A123 B9 FC 0F 
  JSL L_E46D                                      ; 05A126 22 6D E4 00 
  LDA.W $0786,Y                                   ; 05A12A B9 86 07 
  TAY                                             ; 05A12D A8 
...
L_5A4A5:
  ...
  LDA.W $07B6,X                                   ; 05A4A9 BD B6 07 
  AND.B #$F1                                      ; 05A4AC 29 F1 
  STA.W $0697                                     ; 05A4AE 8D 97 06 
  RTS                                             ; 05A4B1 60 

B_5A4B2:
  LDA.W $07B6,X                                   ; 05A4B2 BD B6 07 
...
B_5A595:
  ...
  STA.W XexzyCharX,Y                              ; 05A59C 99 46 0B 
B_5A59F:
  LDA.W $0C9C,Y                                   ; 05A59F B9 9C 0C 
  CMP.B $04                                       ; 05A5A2 C5 04 
  BCS.B B_5A5AD                                   ; 05A5A4 B0 07 
  SEC                                             ; 05A5A6 38 
  SBC.B #$02                                      ; 05A5A7 E9 02 
  STA.W $0C9C,Y                                   ; 05A5A9 99 9C 0C 
  RTS                                             ; 05A5AC 60 
...
.byte $60,$60,$60,$60,$60,$60,$60,$60             ; 05A5C6 ........ ````````
  ...
  CLC                                             ; 05A5D3 18 
  ADC.W $0F48,X                                   ; 05A5D4 7D 48 0F 
  STA.W $0F48,X                                   ; 05A5D7 9D 48 0F 
...
B_5A608:
  LDY.W $1110,X                                   ; 05A608 BC 10 11 
  LDA.B #$00                                      ; 05A60B A9 00 
  STA.W $1AAF,Y                                   ; 05A60D 99 AF 1A 
  LDY.W $14A0,X                                   ; 05A610 BC A0 14 
  ...
  CLC                                             ; 05A629 18 
  LDA.W XexzyCharX,X                              ; 05A62A BD 46 0B 
  ADC.B #$08                                      ; 05A62D 69 08 
  STA.W XexzyCharX,X                              ; 05A62F 9D 46 0B 
  CLC                                             ; 05A632 18 
  LDA.W $0C9C,X                                   ; 05A633 BD 9C 0C 
  ADC.B #$08                                      ; 05A636 69 08 
  STA.W $0C9C,X                                   ; 05A638 9D 9C 0C 
  LDY.W $14A0,X                                   ; 05A63B BC A0 14 
...
B_5A68E:
  ...
  SEC                                             ; 05A690 38 
  LDA.W $0F48,X                                   ; 05A691 BD 48 0F 
  SBC.B $04                                       ; 05A694 E5 04 
  STA.W $0F48,X                                   ; 05A696 9D 48 0F 
  ...
  LDA.W $0FFC,Y                                   ; 05A6A7 B9 FC 0F 
  JSL L_E46D                                      ; 05A6AA 22 6D E4 00 
  LDY.W $1110,X                                   ; 05A6AE BC 10 11 
  LDA.B #$00                                      ; 05A6B1 A9 00 
  STA.W $1AAF,Y                                   ; 05A6B3 99 AF 1A 
  LDY.W $14A0,X                                   ; 05A6B6 BC A0 14 
