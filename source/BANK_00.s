...
Round1RoomIndexes:
;       S   E   N   W
.byte $00,$01,$00 ; (Starting room)
.byte $00,$03,$00 ; ARENA 1
.byte $00,$04,$00 ; COLLECT 10 KEYS!
.byte $02,$00,$06 ; COLLECT POWERUPS!
.byte $00,$05,$08 ; MEET MR. SHRAPNEL
.byte $00,$00,$09 ; BONUS PRIZES!
.byte $00,$07,$00 ; EAT MY SHRAPNEL
.byte $08,$0B,$00 ; TOTAL CARNAGE
.byte $00,$09,$00 ; CROWD CONTROL
.byte $00,$0A,$00 ; TANK TROUBLE
.byte $00,$FF,$00 ; MUTOID MAN!
.byte $09,$00,$04 ; SECRET ROOM #1!
...
@Continue:
  ...
  lda CurrentRound                                ; get current round
  asl a                                           ; double it up
  tax                                             ; and prepare to use as index offset
  lda.w RoundRoomNames+0,x                        ; copy base pointer to room names
  sta $04                                         ;
  lda.w RoundRoomNames+1,x                        ;
  sta $05                                         ;
